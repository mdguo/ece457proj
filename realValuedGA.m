% Continuous Genetic Algorithm or Real-valued GA
%
...
%_______________________________________________________
% III GA parameters
popsize=120; % set population size
...
for i=1:size(par,1)
    cost(i) = GetTotalPathCost(par(i,:), paths, cellAdjacencies, startingAdjacencies, startingCoords, goalCoord);
end
% using ff
...
PlotSpace(fieldDimensions, obstacles, startingCoords, goalCoord, paths, par(1,:), cellAdjacencies, startingAdjacencies);
end